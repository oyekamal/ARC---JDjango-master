...
relay_pins = {
    ...
    9: {"on": 21, "off": 20, "color": "red"},  # Relay 9
    10: {"on": 16, "off": 12, "color": "blue"},  # Relay 10
    11: {"on": 7, "off": 15, "color": "green"},  # Relay 11
    12: {"on": 25, "off": 24, "color": "purple"},  # Relay 12
    13: {"on": 21, "off": 20, "color": "red"},  # Relay 13
    14: {"on": 16, "off": 12, "color": "blue"},  # Relay 14
    15: {"on": 7, "off": 15, "color": "green"},  # Relay 15
    16: {"on": 25, "off": 24, "color": "purple"},  # Relay 16
}
