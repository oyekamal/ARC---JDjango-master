...
class Relay(models.Model):
    ...
    relay_group_associations = models.ManyToManyField('RelayRelayGroupAssociation', related_name='relay_group_associations', null=True, blank=True)
...
class RelayRelayGroupAssociation(models.Model):
    ...
    relay_group = models.ForeignKey(RelayGroup, on_delete=models.CASCADE, related_name='relay_group_associations', null=True, blank=True)
    is_on = models.BooleanField(default=True)
